...
@dataclass
class ScoringModel:
    """Viewership = sport_scale * (network_reach/100) * (combined_pop/100)^team_power"""
    ...
    def predict_viewers(
        ...
        power = self.team_power.get(sport, self.default_team_power)
        team_factor = (combined_popularity / 100.0) ** power
        network_factor = network_reach / 100.0
