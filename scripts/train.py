...
def main() -> None:
    ...
    print(f"  Schedule-tier train rows: {result.n_train}")
    print(f"  Schedule-tier test rows:  {result.n_test}")
    print(f"  Marquee games excluded:   {result.n_marquee} (tagged is_marquee=1)")
